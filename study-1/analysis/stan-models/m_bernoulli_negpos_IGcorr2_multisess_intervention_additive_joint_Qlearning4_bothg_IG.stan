...
transformed parameters {
  ...
  for ( p in 1:nPpts ) {
    ...
    if ( condition[p] == 1 ) {
      // for active intervention participants
      theta_internal_pos[p,2] = mu_internal_theta_pos[2] + pars_tilde_pos[3,p] + theta_int_internal_pos + beta_both_internal*alpha_pos[p];
      theta_global_pos[p,2]   = mu_global_theta_pos[2]   + pars_tilde_pos[4,p] + theta_int_global_pos + beta_both_global*alpha_pos[p];
    } else {
      // for control intervention participants
