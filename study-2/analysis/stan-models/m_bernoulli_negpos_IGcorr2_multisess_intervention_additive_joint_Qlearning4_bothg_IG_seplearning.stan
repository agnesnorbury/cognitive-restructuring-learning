...
transformed parameters {
  ...
  for ( p in 1:nPpts ) {
    ...
    if ( int_condition[p] == 1  && learn_condition[p] == 1 ) {
      // for active intervention participants who completed the learning task
      theta_internal_pos[p,2] = mu_internal_theta_pos[2] + pars_tilde_pos[3,p] + theta_int_internal_pos + theta_learn_internal_pos + beta_causal_internal*alpha_pos[p];
      theta_global_pos[p,2]   = mu_global_theta_pos[2]   + pars_tilde_pos[4,p] + theta_int_global_pos + theta_learn_global_pos + beta_causal_global*alpha_pos[p];
    } else if ( int_condition[p] == 1  && learn_condition[p] == 0 ) {
