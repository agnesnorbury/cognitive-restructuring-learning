...
import { allowDevices, learnCond } from "./versionInfo.js"; 
...
import { timeline_instructions_learning_control } from "./instructionsLearningControl.js";     
import { timeline_learning } from "./taskLearning.js";
import { timeline_learning_control } from "./taskLearningControl.js";
...
export function runStudy(){
    ...
    // 1. initial instructions, choice test 1
    ...
    if ( learnCond == "causal" ) {
        ...
        timeline = timeline.concat(timeline_instructions_learning_control); 
        timeline = timeline.concat(timeline_learning_control);  
    }                
